# Hand tracking sample(All key+cv mapping+pygui)
        ...
        for landmarks in results.multi_hand_landmarks:
            ...
            for i, (x, y, w, h) in enumerate(boxes):
                if x < lm_x < x + w and y < lm_y < y + h:
                    if i == 0: print("Up"), pyautogui.press('up'), time.sleep(0.5)  
                    elif i == 1: print("Right"), pyautogui.press('right')
                    elif i == 2: print("Down"), pyautogui.press('down')
                    elif i == 3: print("Left"), pyautogui.press('left')
                    elif i == 4: print("A"), pyautogui.press('a')
                    elif i == 5: print("B"), pyautogui.press('a')
