...
* 예제7: 좌우 기울기를 이용, 내려오는 벽 피하기 게임(참고: https://microbit-micropython.readthedocs.io/)
```
...
* 예제 8: 1-10까지 수를 세고 10이 되면 도~2옥타브 도까지 노래를 부르는 코드 
```
from microbit import *
import speech
solfa = [
